...
[JsonSerializable(typeof(List<Google.Data.LogEntry>))]
internal partial class LogEntriesJsonContext : JsonSerializerContext { }
...
public class GoogleFluentdSinkTests
{
    ...
    public static async Task AspNetCoreSimpleBase(bool prePopulateContext)
    {
        ...
        var entries = JsonSerializer.Deserialize("[" + output.Replace("}\n", "},\n").TrimEnd('\n', '\r', ',') + "]", LogEntriesJsonContext.Default.ListLogEntry)
            ?? [];
