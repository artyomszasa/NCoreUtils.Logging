...
public sealed class DefaultGoogleLoggingInitializer
    : IGoogleLoggingInitializer
{
    ...
    {
        var projectId = inputProjectId ?? throw new InvalidOperationException("No projectId provided, to provide value specify explicit initializer.");
        var service = inputService switch
        {
            null => preferConfig
                ? default
        ...
        var serviceVersion = inputServiceVersion;
